...
textbox = ct.CTkTextbox(master=ct.CTk, width=50, height= 20)
...
class App(ct.CTk):
    ...
    def __init__(self): 
        ...
        self.img_holder = ct.CTkLabel(master = self.frame_right, text="Diary Daw Dapat", bg_color="gray", font=("Roboto Medium", -14)) # text_font=("Roboto Medium", -14)
        self.img_holder.grid(row=0, column=0, columnspan=2, pady=15, padx=10, sticky="we")


        self.textbox = ct.CTkTextbox(master=self.frame_right, width=500, height= 400, font = ("Roboto Medium", 15))
        self.textbox.grid(row=1, column= 0)

        self.textbox.insert("0.0", "new text to insert...")  # insert at line 0 character 0
        self.text = self.textbox.get("0.0", "end-1c")  # get text from line 0 character 0 till the end
    ...
    def display_img(self, file_path):
        ...
        self.img_holder.configure(text="")
